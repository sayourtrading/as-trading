    ...
    <div className="container" style={{ padding: "28px 20px" }}>
      ...
      <div style={{ background: "#F2F4F7", border: "1px solid #E4E6EA", borderRadius: 6, padding: 14, marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", marginTop: 10 }}>
          ...
          <button onClick={() => setFilters({ q: "", brand: "", vehicleType: "", transmission: "", fuel: "", yearMin: "", yearMax: "", priceMin: "", priceMax: "" })} style={{ background: "none", border: "none", color: "#2FA84F", fontWeight: 600, fontSize: 12, cursor: "pointer" }}>Reset filters</button>
        </div>
      </div>
      {filtered.length === 0 ? (
