...
export default function Header() {
  ...
  return (
    <div style={{ background: "#14294B", color: "#fff" }}>
      <div className="container" style={{ padding: "14px 20px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none", color: "#fff" }}>
          ...
          <img src="/logo.jpg" alt={SETTINGS.companyName} style={{ width: 48, height: 48, borderRadius: "50%", objectFit: "cover", flexShrink: 0 }} />
        ...
        <div style={{ display: "flex", gap: 4, flexWrap: "wrap" }}>
          ...
          <Link href={loggedIn ? "/admin/dashboard" : "/admin/login"} className="btn" style={{ background: "transparent", color: "#2FA84F", border: "1px solid #3A4150", padding: "7px 12px" }}>
