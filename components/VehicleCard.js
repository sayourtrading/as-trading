  ...
  return (
    <div className="card">
      ...
      <div style={{ padding: "12px 14px" }}>
        <Link href={`/vehicle/${v.id}`} className="heading" style={{ fontSize: 18, textDecoration: "none", color: "#1C2128" }}>
          {v.brand} {v.model}
        </Link>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <span className="heading" style={{ fontSize: 18, color: "#C93B26" }}>{v.selling_price ? money(v.selling_price) : "Price on request"}</span>
