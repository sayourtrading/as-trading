...
export default function HomePage() {
  ...
  return (
    <div>
      <div style={{ background: "linear-gradient(120deg, #1C2128 60%, #2E3440 60%)", color: "#fff", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: 0, right: "-5%", bottom: 0, width: "45%", background: "#C93B26", clipPath: "polygon(30% 0, 100% 0, 100% 100%, 0% 100%)" }} />
      ...
      <div className="container" style={{ padding: "40px 20px" }}>
        <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", marginBottom: 18 }}>
          ...
          <Link href="/inventory" style={{ color: "#C93B26", fontWeight: 600, fontSize: 13, textDecoration: "none" }}>See all &rarr;</Link>
        </div>
        {vehicles.length === 0 ? (
